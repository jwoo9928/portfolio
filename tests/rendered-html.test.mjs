...
test("server-renders Jaewoo Park's portfolio and case studies", async () => {
  ...
  assert.match(html, /AI Daily Audit/);
...
test("removes the disposable starter preview", async () => {
  ...
  assert.match(page, /Three problems\. Three production paths\./);
  assert.match(layout, /Jaewoo Park — AI Agent Engineer/);
